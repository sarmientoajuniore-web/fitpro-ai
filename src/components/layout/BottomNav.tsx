...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#111111] border-t border-black/[0.08] flex max-w-lg mx-auto">
        ...
        return (
          <Link
            ...
            className={`flex-1 flex flex-col items-center gap-1 py-2 text-[10px] font-medium transition-colors
              ${active ? 'text-[#F5C518]' : 'text-[#6d7362] hover:text-[#5d6358]'}`}
          >
